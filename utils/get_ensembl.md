...
Get EnsemblVertebrata Data - release-113

```
wget https://ftp.ensembl.org/pub/release-113/species_EnsemblVertebrates.txt
...
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=3 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off https://ftp.ensembl.org/pub/release-113/fasta/"$2"/cds/"}' \
> get_EnsemblVertebrates.sh
tail -n+2 ../species_EnsemblVertebrates.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=3 -r -l 2 -np -A *.113.gtf.gz -pk -e robots=off https://ftp.ensembl.org/pub/release-113/gtf/"$2"/"}' \
...
Get EnsemblMetazoa Data - release-60

```
wget http://ftp.ensemblgenomes.org/pub/metazoa/release-60/species_EnsemblMetazoa.txt
mkdir -p EnsemblMetazoa
cd EnsemblMetazoa
# get EnsemblMetazoa species file
tail -n+2 ../species_EnsemblMetazoa.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/metazoa/release-60/fasta/"$2"/cds/"}' \
> get_EnsemblMetazoa.sh
tail -n+2 ../species_EnsemblMetazoa.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *.60.gtf.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/metazoa/release-60/gtf/"$2"/"}' \
...
Get EnsemblPlants Data - release-60

```
wget http://ftp.ensemblgenomes.org/pub/plants/release-60/species_EnsemblPlants.txt
mkdir -p EnsemblPlants
cd EnsemblPlants
# get EnsemblPlants species file
tail -n+2 ../species_EnsemblPlants.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/plants/release-60/fasta/"$2"/cds/"}' \
> get_EnsemblPlants.sh
tail -n+2 ../species_EnsemblPlants.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *.60.gtf.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/plants/release-60/gtf/"$2"/"}' \
...
Get EnsemblFungi Data - release-60

```
wget http://ftp.ensemblgenomes.org/pub/fungi/release-60/species_EnsemblFungi.txt
mkdir -p EnsemblFungi
cd EnsemblFungi
# get EnsemblFungi species file
tail -n+2 ../species_EnsemblFungi.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/fungi/release-60/fasta/"$2"/cds/"}' \
> get_EnsemblFungi.sh
tail -n+2 ../species_EnsemblFungi.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *.60.gtf.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/fungi/release-60/gtf/"$2"/"}' \
> get_EnsemblFungi_gtf.sh
sh ./get_EnsemblFungi.sh
sh ./get_EnsemblFungi_gtf.sh
tail -n+2 ../species_EnsemblFungi.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=5 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/fungi/release-60/fasta/"$14"/"$2"/cds/"}' | sed 's/_core_60_113_1//g' \
> get_EnsemblFungi_core.sh
tail -n+2 ../species_EnsemblFungi.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=5 -r -l 2 -np -A *.60.gtf.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/fungi/release-60/gtf/"$14"/"$2"/"}' | sed 's/_core_60_113_1//g' \
...
Get EnsemblProtists Data - release-60

```
wget http://ftp.ensemblgenomes.org/pub/protists/release-60/species_EnsemblProtists.txt
mkdir -p EnsemblProtists
cd EnsemblProtists
# get EnsemblProtists species file
tail -n+2 ../species_EnsemblProtists.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/protists/release-60/fasta/"$2"/cds/"}' \
> get_EnsemblProtists.sh
tail -n+2 ../species_EnsemblProtists.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=4 -r -l 2 -np -A *.60.gtf.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/protists/release-60/gtf/"$2"/"}' \
> get_EnsemblProtists_gtf.sh
sh ./get_EnsemblProtists.sh
sh ./get_EnsemblProtists_gtf.sh
tail -n+2 ../species_EnsemblProtists.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=5 -r -l 2 -np -A *cds.all.fa.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/protists/release-60/fasta/"$14"/"$2"/cds/"}' | sed 's/_core_60_113_1//g' \
> get_EnsemblProtists_core.sh
tail -n+2 ../species_EnsemblProtists.txt \
| awk -F'\t' '{print "wget --no-host-directories --cut-dirs=5 -r -l 2 -np -A *.60.gtf.gz -pk -e robots=off http://ftp.ensemblgenomes.org/pub/protists/release-60/gtf/"$14"/"$2"/"}' | sed 's/_core_60_113_1//g' \
...
write.table(t2g, sep="\t", quote=FALSE, col.names=TRUE, row.names=FALSE, file="EnsemblVertebrates-release-113.t2g.tsv")
...
write.table(t2g, sep="\t", quote=FALSE, col.names=TRUE, row.names=FALSE, file="EnsemblMetazoa-release-60.t2g.tsv")
```
...
write.table(t2g, sep="\t", quote=FALSE, col.names=TRUE, row.names=FALSE, file="EnsemblPlants-release-60.t2g.tsv")
```
