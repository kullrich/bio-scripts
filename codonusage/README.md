...
$$N_{c} = \frac {K_1 \sum\limits_{j}^{K_1} n_{j}}{\sum\limits_{j=1}^{K_1}(n_{j}F_{CF.j})} + \frac {K_2 \sum\limits_{j}^{K_2} n_{j}}{} + \frac {K_3 \sum\limits_{j}^{K_3} n_{j}}{} + \frac {K_4 \sum\limits_{j}^{K_4} n_{j}}{} + (\frac {K_6 \sum\limits_{j}^{K_6} n_{j}}{}) $$
